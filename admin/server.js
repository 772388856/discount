...
app.use('/details/*', express.static('../front/index.html'));
app.use('/search', express.static('../front/index.html'));
app.use('/good/*', express.static('../front/index.html'));
app.use('/brand/*', express.static('../front/index.html'));
app.use('/baby/*', express.static('../front/index.html'));
app.use('/goods/*', express.static('../front/index.html'));
app.use('/trend/*', express.static('../front/index.html'));
app.use('/preferential/*', express.static('../front/index.html'));
